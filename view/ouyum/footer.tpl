...
<footer class="ui-footer">
    <div class="container">
        &copy;{date("Y")} {$config['appName']} | Powered by <a href="/staff">SSPANEL</a> theme change by <a href="https://liuliwanjia.top" target="_blank">LIULIWANJIA</a>
...
{/if}
<script src="/theme/ouyum/js/base.min.js"></script>
<script src="/theme/ouyum/js/project.min.js"></script>
