			...
			<div class="ui-card-wrap">
				<div class="row">
                    ...
                    <div class="col-lg-12 col-sm-12 nodelist">
                        ...
                        <div class="ui-switch node-switch" style="display:none;">
                            <div class="card">
                                <div class="card-main">
                        ...
                        {/if}
                            <div class="node-card node-flex" cardindex="{$node@index}">
                                ...
                                <div class="nodestatus">
                                    <div class="{if $node['online'] == '1' || $node['sort'] == '12'}nodeonline{elseif $node['online'] == '0'}nodeunset{else}nodeoffline{/if}">
                                        <i class="material-icons">{if $node['online']=='1' || $node['sort'] == '12'}cloud_queue{elseif $node['online']=='0'}wifi_off{else}flash_off{/if}</i>
                                    </div>
                                </div>
                            </div>
                            <div class="node-tip cust-model" tipindex="{$node@index}">
                                ...
                                {else}
                                    ...
                                    {/if}
                                    <div class="tipmiddle divcenter">
                                        <div>
                                            <span class="node-icon">{$node['info']}</span>
                                        </div>
                                    </div>
...
<script>
    ...
    $(".copy-text").click(function () {
        $("#result").modal();
        $$.getElementById('msg').innerHTML = '已复制<br />{URL::getV2Url($user, $node['raw_node'])}<br />请点击软件中的以剪切板导入即可';
    });
    {literal}
    ;(function () {
        'use strict'
